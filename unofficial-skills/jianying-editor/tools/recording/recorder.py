...
class ProGuiRecorder:
    ...
    def start_actual_recording(self):
        ...
        # 更新按钮状态为录制中
        self.status_label.config(text="🔴 录制中...", fg="#e74c3c")
        self.start_btn.config(state=tk.NORMAL, text="⏹️ 结束录制", bg="#e74c3c", command=self.stop_recording)
    ...
    def stop_recording(self):
        ...
        self.start_btn.config(text="🎬 开始录制", bg="#2ecc71", command=self.start_countdown)
